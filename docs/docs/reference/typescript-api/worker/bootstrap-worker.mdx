...
generated: true
---
<GenerationInfo sourceFile="packages/core/src/bootstrap.ts" sourceLine="254" packageName="@vendure/core" />
...
<GenerationInfo sourceFile="packages/core/src/bootstrap.ts" sourceLine="113" packageName="@vendure/core" since="2.2.0" />
