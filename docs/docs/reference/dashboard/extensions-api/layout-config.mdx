...
<GenerationInfo sourceFile="packages/dashboard/src/lib/framework/extension-api/types/layout-config.ts" sourceLine="143" packageName="@vendure/dashboard" since="3.6.3" />
...
<GenerationInfo sourceFile="packages/dashboard/src/lib/framework/extension-api/types/layout-config.ts" sourceLine="14" packageName="@vendure/dashboard" since="3.6.3" />
...
<GenerationInfo sourceFile="packages/dashboard/src/lib/framework/extension-api/types/layout-config.ts" sourceLine="55" packageName="@vendure/dashboard" since="3.6.3" />
