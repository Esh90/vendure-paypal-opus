...
exports.PayPalShopResolver = void 0;
const graphql_1 = require("@nestjs/graphql");
const core_1 = require("@vendure/core");
const paypal_service_1 = require("./paypal.service");
let PayPalShopResolver = class PayPalShopResolver {
    constructor(paypalService, activeOrderService) {
...
exports.PayPalShopResolver = PayPalShopResolver;
__decorate([
...
], PayPalShopResolver.prototype, "createPayPalOrder", null);
exports.PayPalShopResolver = PayPalShopResolver = __decorate([
    (0, graphql_1.Resolver)(),
    __metadata("design:paramtypes", [paypal_service_1.PayPalService,
        core_1.ActiveOrderService])
], PayPalShopResolver);
//# sourceMappingURL=paypal.resolver.js.map