...
generated: true
---
<GenerationInfo sourceFile="packages/dashboard/src/lib/components/shared/translatable-form-field.tsx" sourceLine="151" packageName="@vendure/dashboard" since="3.4.0" />
...
<GenerationInfo sourceFile="packages/dashboard/src/lib/components/shared/translatable-form-field.tsx" sourceLine="25" packageName="@vendure/dashboard" since="3.4.0" />
