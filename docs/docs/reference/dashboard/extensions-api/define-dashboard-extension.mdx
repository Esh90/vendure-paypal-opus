...
generated: true
---
<GenerationInfo sourceFile="packages/dashboard/src/lib/framework/extension-api/define-dashboard-extension.ts" sourceLine="87" packageName="@vendure/dashboard" since="3.3.0" />
...
<GenerationInfo sourceFile="packages/dashboard/src/lib/framework/extension-api/extension-api-types.ts" sourceLine="36" packageName="@vendure/dashboard" since="3.3.0" />
