...
generated: true
---
<GenerationInfo sourceFile="packages/dashboard/src/lib/framework/extension-api/define-dashboard-extension.ts" sourceLine="63" packageName="@vendure/dashboard" since="3.3.0" />
...
<MemberInfo kind="property" type={`Record<string, string | React.ReactNode>`}  since="3.6.0"  />
